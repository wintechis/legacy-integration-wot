...
client = Client()
path_to_devices = "/home/rene/Repositories/PhD/retrowot/retrowot/woble_system/experiments/devices.json"
path_to_experiment = "/home/rene/Repositories/PhD/retrowot/retrowot/woble_system/experiments/"
...
async def discover():
    ...
    for device in client.bluetooth_devices.values():
        ...
        if device.address.uuid not in devices:
            ...
            report.devices[device.address.uuid] = DeviceReport(address=device.address.uuid)
            try:
            ...
            for service in device.services:
                ...
                for characteristic in service.characteristics:
                    service_report.characteristics.append(CharacteristicReport(uuid=characteristic.uuid))
